...
"duel":"Usage: 322 duel @User  | Both duellers must have 600 gold to start a duel. After a short delay, sends 17 questions(one by one) which can be answered by both duel participants, first to answer gets +1 point, if the first answer to be sent is incorrect the challenger will lose 1 point. After all 17 questions are answered the winner will get 400 gold while the loser loses 600 gold.",
