...
"scramble":"Sends a scrambled/shuffled word associated with DotA2 and you must guess what word it is. The word could be a hero name, an item name or an ability name.",
